package com.konteneryzacja.kantor.config;
...
import static com.konteneryzacja.kantor.user.Permission.*;
import static com.konteneryzacja.kantor.user.Role.ADMIN;
...
public class SecurityConfiguration {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/auth/**", "/api/rates/**"};
